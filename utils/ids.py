...
class GuildNames:
    ...
    TRAINING_GROUNDS = "PlayVS Smash Server"
...
class GuildIDs:
    """The unique Server IDs. Paino: i mightve broke it with battlegrounds but ill find out later"""
...
class TGChannelIDs:
    """Contains Channel IDs used throughout the code, specific to the Training Grounds Server (Redone)."""
    ...
    STARBOARD_LISTENING_CHANNELS = (xx,)
